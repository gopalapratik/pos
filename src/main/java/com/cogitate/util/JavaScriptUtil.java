...
public class JavaScriptUtil {
	...
	public static void flash(List<WebElement> element, WebDriver driver) {
		String bgcolor = element.get(0).getCssValue("backgroundColor");
		for (int i = 0; i < 7; i++) {
			changeColor("rgb(0,200,0)", element.get(i), driver);// 1
			changeColor(bgcolor, element.get(i), driver);// 2
		}
	}
